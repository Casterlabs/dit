...
public class Dit {
    ...
    public static final Pattern MEDIA_PATTERN = Pattern.compile("\\[media .+?\\]", Pattern.CASE_INSENSITIVE);
    public static final int MEDIA_SUBSTR_START = "[media ".length();
    public static final int MEDIA_SUBSTR_END_DELTA = "]".length();
